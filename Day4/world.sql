-- PostgreSQL doesn't have the same database file configuration options as SQL Server
-- We simply create the database
CREATE DATABASE "World";

-- Connect to the new database
\c "World"

-- PostgreSQL handles most of the SQL Server settings differently or they're not applicable
-- Below are the relevant settings that can be configured in PostgreSQL

-- Set the search path (similar to USE in SQL Server)
SET search_path TO public;

-- Create the City table (basic structure - you'll need to add columns)
CREATE TABLE "City" (
...
-- PostgreSQL equivalent settings for some of the SQL Server configurations:
ALTER DATABASE "World" SET datestyle TO 'ISO, MDY';
ALTER DATABASE "World" SET timezone TO 'UTC';
ALTER DATABASE "World" SET default_text_search_config TO 'pg_catalog.english';

-- Note: Many of the SQL Server database settings don't have direct equivalents in PostgreSQL
-- or are handled differently in the PostgreSQL architecture.
...
-- PostgreSQL doesn't have clustered indexes in the same way as SQL Server
-- You might want to create a regular index if needed:
-- CREATE INDEX idx_city_id ON "City" ("ID");

CREATE TABLE "Country" (
    "Code" CHAR(3) NOT NULL,
    "Name" CHAR(52) NOT NULL,
    "Continent" VARCHAR(50) NOT NULL,  -- Changed from NVARCHAR to VARCHAR
    "Region" CHAR(26) NOT NULL,
    "SurfaceArea" DOUBLE PRECISION NOT NULL,  -- FLOAT in PostgreSQL is DOUBLE PRECISION
    "IndepYear" SMALLINT,
    "Population" INTEGER NOT NULL,
...
CREATE TABLE "CountryLanguage" (
    ...
    "IsOfficial" BOOLEAN NOT NULL,  -- BIT maps to BOOLEAN in PostgreSQL
    "Percentage" DOUBLE PRECISION NOT NULL,
    PRIMARY KEY ("CountryCode", "Language")
);
-- No need for SET ANSI_PADDING in PostgreSQL
